...
"label" => "Analytics",
"icon" => "TabAnalytics",
"description" => "Kontorol supports robust analytics via the Kontorol platform as well as via 3rd party analytics providers.",
"type" => "menu",
"model" => "analytics",
"children"=> array(
...
"description" => "The Kontorol platform supports VAST 3.0 as well as 3rd party ad plugins to facilitate content monetization.",
"type" => "menu",
"model" => "monitization",
"children"=> array(
array(
