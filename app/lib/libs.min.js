...
+function (a) {
    ...
    function i(a, b, c) {
        var d = a.charAt(0).toUpperCase() + a.slice(1), f = (a + " " + w.join(d + " ") + d).split(" ");
        return e(b, "string") || e(b, "undefined") ? g(f, b) : (f = (a + " " + x.join(d + " ") + d).split(" "), h(f, b, c))
    }

    function j() {
        n.input = function (c) {
            for (var d = 0, e = c.length; e > d; d++) A[c[d]] = c[d] in t;
    ...
    var k, l, m = "2.7.1", n = {}, o = !0, p = b.documentElement, q = "modernizr", r = b.createElement(q), s = r.style,
        ...
        x = v.toLowerCase().split(" "), y = {}, z = {}, A = {}, B = [], C = B.slice, D = function (a, c, d, e) {
            ...
            var d;
            return D("@media " + b + " { #" + q + " { position: absolute; } }", function (b) {
    ...
    l = e(F, "undefined") || e(F.call, "undefined") ? function (a, b) {
        ...
        var c = C.call(arguments, 1), d = function () {
    ...
    return n.input || j(), n.addTest = function (a, b) {
        ...
        return n
    }, d(""), r = t = null, n._version = m, n._domPrefixes = x, n._cssomPrefixes = w, n.mq = E, n.testProp = function (a) {
        return g([a])
    }, n.testAllProps = i, n.testStyles = D, p.className = p.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (o ? " js " + B.join(" ") : ""), n
    ...
    var b = {
        init: function (b) {
            ...
            return this.each(function () {
                var c = a(this);
                if (b.set_width && c.css("width", b.set_width), b.set_height && c.css("height", b.set_height), a(document).data("mCustomScrollbar-index")) {
                    var d = parseInt(a(document).data("mCustomScrollbar-index"));
                    a(document).data("mCustomScrollbar-index", d + 1)
                } else a(document).data("mCustomScrollbar-index", "1");
                c.wrapInner("<div class='mCustomScrollBox mCS-" + b.theme + "' id='mCSB_" + a(document).data("mCustomScrollbar-index") + "' style='position:relative; height:100%; overflow:hidden; max-width:100%;' />").addClass("mCustomScrollbar _mCS_" + a(document).data("mCustomScrollbar-index"));
                var e = c.children(".mCustomScrollBox");
                if (b.horizontalScroll) {
                    ...
                    var f = e.children(".mCSB_h_wrapper");
                    f.wrapInner("<div class='mCSB_container' style='position:absolute; left:0;' />").children(".mCSB_container").css({
                        width: f.children().outerWidth(),
                        position: "relative"
                    }).unwrap()
                } else e.wrapInner("<div class='mCSB_container' style='position:relative; top:0;' />");
                var g = e.children(".mCSB_container");
                a.support.touch && g.addClass("mCS_touch"), g.after("<div class='mCSB_scrollTools' style='position:absolute;'><div class='mCSB_draggerContainer'><div class='mCSB_dragger' style='position:absolute;' oncontextmenu='return false;'><div class='mCSB_dragger_bar' style='position:relative;'></div></div><div class='mCSB_draggerRail'></div></div></div>");
                var h = e.children(".mCSB_scrollTools"), i = h.children(".mCSB_draggerContainer"),
                    j = i.children(".mCSB_dragger");
                if (b.horizontalScroll ? j.data("minDraggerWidth", j.width()) : j.data("minDraggerHeight", j.height()), b.scrollButtons.enable && (b.horizontalScroll ? h.prepend("<a class='mCSB_buttonLeft' oncontextmenu='return false;'></a>").append("<a class='mCSB_buttonRight' oncontextmenu='return false;'></a>") : h.prepend("<a class='mCSB_buttonUp' oncontextmenu='return false;'></a>").append("<a class='mCSB_buttonDown' oncontextmenu='return false;'></a>")), e.bind("scroll", function () {
                    c.is(".mCS_disabled") || e.scrollTop(0).scrollLeft(0)
                }), c.data({
                    mCS_Init: !0,
                ...
                }), b.horizontalScroll) "none" !== c.css("max-width") && (b.advanced.updateOnContentResize || (b.advanced.updateOnContentResize = !0)); else if ("none" !== c.css("max-height")) {
                    var k = !1, l = parseInt(c.css("max-height"));
                    c.css("max-height").indexOf("%") >= 0 && (k = l, l = c.parent().height() * k / 100), c.css("overflow", "hidden"), e.css("max-height", l)
                }
                if (c.mCustomScrollbar("update"), b.advanced.updateOnBrowserResize) {
                    var m, n = a(window).width(), o = a(window).height();
                    a(window).bind("resize." + c.data("mCustomScrollbarIndex"), function () {
                        m && clearTimeout(m), m = setTimeout(function () {
                            if (!c.is(".mCS_disabled") && !c.is(".mCS_destroyed")) {
                                var b = a(window).width(), d = a(window).height();
                                (n !== b || o !== d) && ("none" !== c.css("max-height") && k && e.css("max-height", c.parent().height() * k / 100), c.mCustomScrollbar("update"), n = b, o = d)
                            }
                        }, 150)
                    })
                }
                if (b.advanced.updateOnContentResize) {
                    var p;
                    if (b.horizontalScroll) var q = g.outerWidth(); else var q = g.outerHeight();
                    p = setInterval(function () {
                        if (b.horizontalScroll) {
                            b.advanced.autoExpandHorizontalScroll && g.css({
                                position: "absolute",
                                width: "auto"
                            ...
                            var a = g.outerWidth()
                        } else var a = g.outerHeight();
                        a != q && (c.mCustomScrollbar("update"), q = a)
                    }, 300)
                }
            })
        }, update: function () {
            var b = a(this), c = b.children(".mCustomScrollBox"), d = c.children(".mCSB_container");
            d.removeClass("mCS_no_scrollbar"), b.removeClass("mCS_disabled mCS_destroyed"), c.scrollTop(0).scrollLeft(0);
            var e = c.children(".mCSB_scrollTools"), f = e.children(".mCSB_draggerContainer"),
                g = f.children(".mCSB_dragger");
            if (b.data("horizontalScroll")) {
                var h = e.children(".mCSB_buttonLeft"), i = e.children(".mCSB_buttonRight"), j = c.width();
                b.data("autoExpandHorizontalScroll") && d.css({
                    position: "absolute",
                    width: "auto"
                }).wrap("<div class='mCSB_h_wrapper' style='position:relative; left:0; width:999999px;' />").css({
                    width: d.outerWidth(),
                ...
                var k = d.outerWidth()
            } else var l = e.children(".mCSB_buttonUp"), m = e.children(".mCSB_buttonDown"), n = c.height(),
                o = d.outerHeight();
            if (o > n && !b.data("horizontalScroll")) {
                e.css("display", "block");
                var p = f.height();
                if (b.data("autoDraggerLength")) {
                    var q = Math.round(n / o * p), r = g.data("minDraggerHeight");
                    if (r >= q) g.css({height: r}); else if (q >= p - 10) {
                        var s = p - 10;
                        g.css({height: s})
                    } else g.css({height: q});
                    g.children(".mCSB_dragger_bar").css({"line-height": g.height() + "px"})
                }
                var t = g.height(), u = (o - n) / (p - t);
                b.data("scrollAmount", u).mCustomScrollbar("scrolling", c, d, f, g, l, m, h, i);
                var v = Math.abs(d.position().top);
                b.mCustomScrollbar("scrollTo", v, {scrollInertia: 0, trigger: "internal"})
            } else if (k > j && b.data("horizontalScroll")) {
                e.css("display", "block");
                var w = f.width();
                if (b.data("autoDraggerLength")) {
                    var x = Math.round(j / k * w), y = g.data("minDraggerWidth");
                    if (y >= x) g.css({width: y}); else if (x >= w - 10) {
                        var z = w - 10;
                        g.css({width: z})
                    } else g.css({width: x})
                }
                var A = g.width(), u = (k - j) / (w - A);
                b.data("scrollAmount", u).mCustomScrollbar("scrolling", c, d, f, g, l, m, h, i);
                var v = Math.abs(d.position().left);
                b.mCustomScrollbar("scrollTo", v, {scrollInertia: 0, trigger: "internal"})
            } else c.unbind("mousewheel focusin"), b.data("horizontalScroll") ? g.add(d).css("left", 0) : g.add(d).css("top", 0), b.data("alwaysShowScrollbar") ? b.data("horizontalScroll") ? b.data("horizontalScroll") && g.css({width: f.width()}) : g.css({height: f.height()}) : (e.css("display", "none"), d.addClass("mCS_no_scrollbar")), b.data({
                bindEvent_mousewheel: !1,
                bindEvent_focusin: !1
            })
        }, scrolling: function (b, d, e, f, g, h, i, j) {
            function k(a, b, c, d) {
                n.data("horizontalScroll") ? n.mCustomScrollbar("scrollTo", f.position().left - b + d, {
                    moveDragger: !0,
                    trigger: "internal"
                }) : n.mCustomScrollbar("scrollTo", f.position().top - a + c, {moveDragger: !0, trigger: "internal"})
            }

            function l(a) {
                f.data("preventAction") || (f.data("preventAction", !0), n.mCustomScrollbar("scrollTo", a, {trigger: "internal"}))
            }

            function m() {
                var a = n.data("scrollButtons_scrollSpeed");
                return "auto" === n.data("scrollButtons_scrollSpeed") && (a = Math.round((n.data("scrollInertia") + 100) / 40)), a
            }

            var n = a(this);
            if (!n.data("bindEvent_scrollbar_drag")) {
                var o, p, q, r, s;
                a.support.pointer ? (q = "pointerdown", r = "pointermove", s = "pointerup") : a.support.msPointer && (q = "MSPointerDown", r = "MSPointerMove", s = "MSPointerUp"), a.support.pointer || a.support.msPointer ? (f.bind(q, function (b) {
                    b.preventDefault(), n.data({on_drag: !0}), f.addClass("mCSB_dragger_onDrag");
                    var c = a(this), d = c.offset(), e = b.originalEvent.pageX - d.left,
                        g = b.originalEvent.pageY - d.top;
                    e < c.width() && e > 0 && g < c.height() && g > 0 && (o = g, p = e)
                }), a(document).bind(r + "." + n.data("mCustomScrollbarIndex"), function (a) {
                    if (a.preventDefault(), n.data("on_drag")) {
                        var b = f, c = b.offset(), d = a.originalEvent.pageX - c.left,
                            e = a.originalEvent.pageY - c.top;
                        k(o, p, e, d)
                    }
                }).bind(s + "." + n.data("mCustomScrollbarIndex"), function () {
                    n.data({on_drag: !1}), f.removeClass("mCSB_dragger_onDrag")
                })) : (f.bind("mousedown touchstart", function (b) {
                    b.preventDefault(), b.stopImmediatePropagation();
                    var c, d, e = a(this), g = e.offset();
                    if ("touchstart" === b.type) {
                        var h = b.originalEvent.touches[0] || b.originalEvent.changedTouches[0];
                        c = h.pageX - g.left, d = h.pageY - g.top
                    } else n.data({on_drag: !0}), f.addClass("mCSB_dragger_onDrag"), c = b.pageX - g.left, d = b.pageY - g.top;
                    c < e.width() && c > 0 && d < e.height() && d > 0 && (o = d, p = c)
                }).bind("touchmove", function (b) {
                    b.preventDefault(), b.stopImmediatePropagation();
                    var c = b.originalEvent.touches[0] || b.originalEvent.changedTouches[0], d = a(this),
                        e = d.offset(), f = c.pageX - e.left, g = c.pageY - e.top;
                    k(o, p, g, f)
                }), a(document).bind("mousemove." + n.data("mCustomScrollbarIndex"), function (a) {
                    if (n.data("on_drag")) {
                        var b = f, c = b.offset(), d = a.pageX - c.left, e = a.pageY - c.top;
                        k(o, p, e, d)
                    }
                }).bind("mouseup." + n.data("mCustomScrollbarIndex"), function () {
                    n.data({on_drag: !1}), f.removeClass("mCSB_dragger_onDrag")
                })), n.data({bindEvent_scrollbar_drag: !0})
            }
            if (a.support.touch && n.data("contentTouchScroll") && !n.data("bindEvent_content_touch")) {
                var t, u, v, w, x, y, z;
                d.bind("touchstart", function (b) {
                    b.stopImmediatePropagation(), t = b.originalEvent.touches[0] || b.originalEvent.changedTouches[0], u = a(this), v = u.offset(), x = t.pageX - v.left, w = t.pageY - v.top, y = w, z = x
                }), d.bind("touchmove", function (b) {
                    b.preventDefault(), b.stopImmediatePropagation(), t = b.originalEvent.touches[0] || b.originalEvent.changedTouches[0], u = a(this).parent(), v = u.offset(), x = t.pageX - v.left, w = t.pageY - v.top, n.data("horizontalScroll") ? n.mCustomScrollbar("scrollTo", z - x, {trigger: "internal"}) : n.mCustomScrollbar("scrollTo", y - w, {trigger: "internal"})
                })
            }
            if (n.data("bindEvent_scrollbar_click") || (e.bind("click", function (b) {
                var c = (b.pageY - e.offset().top) * n.data("scrollAmount"), d = a(b.target);
                n.data("horizontalScroll") && (c = (b.pageX - e.offset().left) * n.data("scrollAmount")), (d.hasClass("mCSB_draggerContainer") || d.hasClass("mCSB_draggerRail")) && n.mCustomScrollbar("scrollTo", c, {
                    trigger: "internal",
                    scrollEasing: "draggerRailEase"
                })
            }), n.data({bindEvent_scrollbar_click: !0})), n.data("mouseWheel") && (n.data("bindEvent_mousewheel") || (b.bind("mousewheel", function (a, b) {
                var c, g = n.data("mouseWheelPixels"), h = Math.abs(d.position().top), i = f.position().top,
                    j = e.height() - f.height();
                n.data("normalizeMouseWheelDelta") && (b = 0 > b ? -1 : 1), "auto" === g && (g = 100 + Math.round(n.data("scrollAmount") / 2)), n.data("horizontalScroll") && (i = f.position().left, j = e.width() - f.width(), h = Math.abs(d.position().left)), (b > 0 && 0 !== i || 0 > b && i !== j) && (a.preventDefault(), a.stopImmediatePropagation()), c = h - b * g, n.mCustomScrollbar("scrollTo", c, {trigger: "internal"})
            }), n.data({bindEvent_mousewheel: !0}))), n.data("scrollButtons_enable")) if ("pixels" === n.data("scrollButtons_scrollType")) n.data("horizontalScroll") ? (j.add(i).unbind("mousedown touchstart MSPointerDown pointerdown mouseup MSPointerUp pointerup mouseout MSPointerOut pointerout touchend", A, B), n.data({bindEvent_buttonsContinuous_x: !1}), n.data("bindEvent_buttonsPixels_x") || (j.bind("click", function (a) {
                a.preventDefault(), l(Math.abs(d.position().left) + n.data("scrollButtons_scrollAmount"))
            }), i.bind("click", function (a) {
                a.preventDefault(), l(Math.abs(d.position().left) - n.data("scrollButtons_scrollAmount"))
            }), n.data({bindEvent_buttonsPixels_x: !0}))) : (h.add(g).unbind("mousedown touchstart MSPointerDown pointerdown mouseup MSPointerUp pointerup mouseout MSPointerOut pointerout touchend", A, B), n.data({bindEvent_buttonsContinuous_y: !1}), n.data("bindEvent_buttonsPixels_y") || (h.bind("click", function (a) {
                a.preventDefault(), l(Math.abs(d.position().top) + n.data("scrollButtons_scrollAmount"))
            }), g.bind("click", function (a) {
                a.preventDefault(), l(Math.abs(d.position().top) - n.data("scrollButtons_scrollAmount"))
            }), n.data({bindEvent_buttonsPixels_y: !0}))); else if (n.data("horizontalScroll")) {
                if (j.add(i).unbind("click"), n.data({bindEvent_buttonsPixels_x: !1}), !n.data("bindEvent_buttonsContinuous_x")) {
                    j.bind("mousedown touchstart MSPointerDown pointerdown", function (a) {
                        a.preventDefault();
                        var b = m();
                        n.data({
                            mCSB_buttonScrollRight: setInterval(function () {
                                n.mCustomScrollbar("scrollTo", Math.abs(d.position().left) + b, {
                                    trigger: "internal",
                    ...
                    var A = function (a) {
                        a.preventDefault(), clearInterval(n.data("mCSB_buttonScrollRight"))
                    };
                    j.bind("mouseup touchend MSPointerUp pointerup mouseout MSPointerOut pointerout", A), i.bind("mousedown touchstart MSPointerDown pointerdown", function (a) {
                        a.preventDefault();
                        var b = m();
                        n.data({
                    ...
                    var B = function (a) {
                        a.preventDefault(), clearInterval(n.data("mCSB_buttonScrollLeft"))
                    };
                    i.bind("mouseup touchend MSPointerUp pointerup mouseout MSPointerOut pointerout", B), n.data({bindEvent_buttonsContinuous_x: !0})
                }
            } else if (h.add(g).unbind("click"), n.data({bindEvent_buttonsPixels_y: !1}), !n.data("bindEvent_buttonsContinuous_y")) {
                h.bind("mousedown touchstart MSPointerDown pointerdown", function (a) {
                    a.preventDefault();
                    var b = m();
                    n.data({
                        mCSB_buttonScrollDown: setInterval(function () {
                            n.mCustomScrollbar("scrollTo", Math.abs(d.position().top) + b, {
                                trigger: "internal",
                                scrollEasing: "easeOutCirc"
                            })
                        }, 17)
                ...
                var C = function (a) {
                    a.preventDefault(), clearInterval(n.data("mCSB_buttonScrollDown"))
                };
                h.bind("mouseup touchend MSPointerUp pointerup mouseout MSPointerOut pointerout", C), g.bind("mousedown touchstart MSPointerDown pointerdown", function (a) {
                    a.preventDefault();
                    var b = m();
                    n.data({
                ...
                var D = function (a) {
                    a.preventDefault(), clearInterval(n.data("mCSB_buttonScrollUp"))
                };
                g.bind("mouseup touchend MSPointerUp pointerup mouseout MSPointerOut pointerout", D), n.data({bindEvent_buttonsContinuous_y: !0})
            }
            n.data("autoScrollOnFocus") && (n.data("bindEvent_focusin") || (b.bind("focusin", function () {
                b.scrollTop(0).scrollLeft(0);
                var c = a(document.activeElement);
                if (c.is("input,textarea,select,button,a[tabindex],area,object")) {
                    var e = d.position().top, f = c.position().top, g = b.height() - c.outerHeight();
                    n.data("horizontalScroll") && (e = d.position().left, f = c.position().left, g = b.width() - c.outerWidth()), (0 > e + f || e + f > g) && n.mCustomScrollbar("scrollTo", f, {trigger: "internal"})
                }
            }), n.data({bindEvent_focusin: !0}))), n.data("autoHideScrollbar") && !n.data("alwaysShowScrollbar") && (n.data("bindEvent_autoHideScrollbar") || (b.bind("mouseenter", function () {
                b.addClass("mCS-mouse-over"), c.showScrollbar.call(b.children(".mCSB_scrollTools"))
            }).bind("mouseleave touchend", function (a) {
                b.removeClass("mCS-mouse-over"), "mouseleave" === a.type && c.hideScrollbar.call(b.children(".mCSB_scrollTools"))
            }), n.data({bindEvent_autoHideScrollbar: !0})))
        }, scrollTo: function (b, d) {
            function e(a) {
                if (k.data("mCustomScrollbarIndex")) switch (this.mcs = {
                    top: n.position().top,
                    left: n.position().left,
                    draggerTop: q.position().top,
                    draggerLeft: q.position().left,
                    topPct: Math.round(100 * Math.abs(n.position().top) / Math.abs(n.outerHeight() - m.height())),
                    leftPct: Math.round(100 * Math.abs(n.position().left) / Math.abs(n.outerWidth() - m.width()))
                }, a) {
                    case"onScrollStart":
                        k.data("mCS_tweenRunning", !0).data("onScrollStart_Callback").call(k, this.mcs);
                        break;
                    case"whileScrolling":
            ...
            var f, g, h, i, j, k = a(this), l = {
                    moveDragger: !1,
                    trigger: "external",
                    callbacks: !0,
                    scrollInertia: k.data("scrollInertia"),
                    scrollEasing: k.data("scrollEasing")
                }, d = a.extend(l, d), m = k.children(".mCustomScrollBox"), n = m.children(".mCSB_container"),
                o = m.children(".mCSB_scrollTools"), p = o.children(".mCSB_draggerContainer"),
                q = p.children(".mCSB_dragger"), r = draggerSpeed = d.scrollInertia;
            if (!n.hasClass("mCS_no_scrollbar") && (k.data({mCS_trigger: d.trigger}), k.data("mCS_Init") && (d.callbacks = !1), b || 0 === b)) {
                if ("number" == typeof b) d.moveDragger ? (f = b, b = k.data("horizontalScroll") ? q.position().left * k.data("scrollAmount") : q.position().top * k.data("scrollAmount"), draggerSpeed = 0) : f = b / k.data("scrollAmount"); else if ("string" == typeof b) {
                    var s;
                    s = "top" === b ? 0 : "bottom" !== b || k.data("horizontalScroll") ? "left" === b ? 0 : "right" === b && k.data("horizontalScroll") ? n.outerWidth() - m.width() : "first" === b ? k.find(".mCSB_container").find(":first") : "last" === b ? k.find(".mCSB_container").find(":last") : k.find(b) : n.outerHeight() - m.height(), 1 === s.length ? (b = k.data("horizontalScroll") ? s.position().left : s.position().top, f = b / k.data("scrollAmount")) : f = b = s
                }
                if (k.data("horizontalScroll")) {
                    k.data("onTotalScrollBack_Offset") && (h = -k.data("onTotalScrollBack_Offset")), k.data("onTotalScroll_Offset") && (j = m.width() - n.outerWidth() + k.data("onTotalScroll_Offset")), 0 > f ? (f = b = 0, clearInterval(k.data("mCSB_buttonScrollLeft")), h || (g = !0)) : f >= p.width() - q.width() ? (f = p.width() - q.width(), b = m.width() - n.outerWidth(), clearInterval(k.data("mCSB_buttonScrollRight")), j || (i = !0)) : b = -b;
                    var t = k.data("snapAmount");
                    t && (b = Math.round(b / t) * t - k.data("snapOffset")), c.mTweenAxis.call(this, q[0], "left", Math.round(f), draggerSpeed, d.scrollEasing), c.mTweenAxis.call(this, n[0], "left", Math.round(b), r, d.scrollEasing, {
                        onStart: function () {
                            d.callbacks && !k.data("mCS_tweenRunning") && e("onScrollStart"), k.data("autoHideScrollbar") && !k.data("alwaysShowScrollbar") && c.showScrollbar.call(o)
                        }, onUpdate: function () {
                            d.callbacks && e("whileScrolling")
                        }, onComplete: function () {
                            d.callbacks && (e("onScroll"), (g || h && n.position().left >= h) && e("onTotalScrollBack"), (i || j && n.position().left <= j) && e("onTotalScroll")), q.data("preventAction", !1), k.data("mCS_tweenRunning", !1), k.data("autoHideScrollbar") && !k.data("alwaysShowScrollbar") && (m.hasClass("mCS-mouse-over") || c.hideScrollbar.call(o))
                        }
                    })
                } else {
                    k.data("onTotalScrollBack_Offset") && (h = -k.data("onTotalScrollBack_Offset")), k.data("onTotalScroll_Offset") && (j = m.height() - n.outerHeight() + k.data("onTotalScroll_Offset")), 0 > f ? (f = b = 0, clearInterval(k.data("mCSB_buttonScrollUp")), h || (g = !0)) : f >= p.height() - q.height() ? (f = p.height() - q.height(), b = m.height() - n.outerHeight(), clearInterval(k.data("mCSB_buttonScrollDown")), j || (i = !0)) : b = -b;
                    var t = k.data("snapAmount");
                    t && (b = Math.round(b / t) * t - k.data("snapOffset")), c.mTweenAxis.call(this, q[0], "top", Math.round(f), draggerSpeed, d.scrollEasing), c.mTweenAxis.call(this, n[0], "top", Math.round(b), r, d.scrollEasing, {
                        onStart: function () {
                            d.callbacks && !k.data("mCS_tweenRunning") && e("onScrollStart"), k.data("autoHideScrollbar") && !k.data("alwaysShowScrollbar") && c.showScrollbar.call(o)
                        }, onUpdate: function () {
                            d.callbacks && e("whileScrolling")
                        }, onComplete: function () {
                            d.callbacks && (e("onScroll"), (g || h && n.position().top >= h) && e("onTotalScrollBack"), (i || j && n.position().top <= j) && e("onTotalScroll")), q.data("preventAction", !1), k.data("mCS_tweenRunning", !1), k.data("autoHideScrollbar") && !k.data("alwaysShowScrollbar") && (m.hasClass("mCS-mouse-over") || c.hideScrollbar.call(o))
                        }
                    })
                }
                k.data("mCS_Init") && k.data({mCS_Init: !1})
            }
        }, stop: function () {
            var b = a(this), d = b.children().children(".mCSB_container"),
                e = b.children().children().children().children(".mCSB_dragger");
            c.mTweenAxisStop.call(this, d[0]), c.mTweenAxisStop.call(this, e[0])
        }, disable: function (b) {
            var c = a(this), d = c.children(".mCustomScrollBox"), e = d.children(".mCSB_container"),
                f = d.children(".mCSB_scrollTools"), g = f.children().children(".mCSB_dragger");
            d.unbind("mousewheel focusin mouseenter mouseleave touchend"), e.unbind("touchstart touchmove"), b && (c.data("horizontalScroll") ? g.add(e).css("left", 0) : g.add(e).css("top", 0)), f.css("display", "none"), e.addClass("mCS_no_scrollbar"), c.data({
                bindEvent_mousewheel: !1,
                bindEvent_focusin: !1,
                bindEvent_content_touch: !1,
                bindEvent_autoHideScrollbar: !1
        ...
        showScrollbar: function () {
        ...
        }, mTweenAxis: function (a, b, c, d, e, f) {
            function g() {
                return window.performance && window.performance.now ? window.performance.now() : window.performance && window.performance.webkitNow ? window.performance.webkitNow() : Date.now ? Date.now() : (new Date).getTime()
            }

            function h() {
                r || n.call(), r = g() - q, i(), r >= a._time && (a._time = r > a._time ? r + m - (r - a._time) : r + m - 1, a._time < r + 1 && (a._time = r + 1)), a._time < d ? a._id = _request(h) : p.call()
            }

            function i() {
                d > 0 ? (a.currVal = l(a._time, s, u, d, e), t[b] = Math.round(a.currVal) + "px") : t[b] = c + "px", o.call()
            }

            function j() {
                m = 1e3 / 60, a._time = r + m, _request = window.requestAnimationFrame ? window.requestAnimationFrame : function (a) {
            ...
            var m, f = f || {}, n = f.onStart || function () {
            }, o = f.onUpdate || function () {
            }, p = f.onComplete || function () {
            }, q = g(), r = 0, s = a.offsetTop, t = a.style;
            "left" === b && (s = a.offsetLeft);
            var u = c - s;
            k(), j()
        }, mTweenAxisStop: function (a) {
            null != a._id && (window.requestAnimationFrame ? window.cancelAnimationFrame(a._id) : clearTimeout(a._id), a._id = null)
        }, rafPolyfill: function () {
            for (var a = ["ms", "moz", "webkit", "o"], b = a.length; --b > -1 && !window.requestAnimationFrame;) window.requestAnimationFrame = window[a[b] + "RequestAnimationFrame"], window.cancelAnimationFrame = window[a[b] + "CancelAnimationFrame"] || window[a[b] + "CancelRequestAnimationFrame"]
        }
    };
    c.rafPolyfill.call(), a.support.touch = !!("ontouchstart" in window), a.support.pointer = window.navigator.pointerEnabled, a.support.msPointer = window.navigator.msPointerEnabled;
    var d = "https:" == document.location.protocol ? "https:" : "http:";
    a.event.special.mousewheel || document.write('<script src="' + d + '//cdnjs.cloudflare.com/ajax/libs/jquery-mousewheel/3.0.6/jquery.mousewheel.min.js"></script>'), a.fn.mCustomScrollbar = function (c) {
...
}(jQuery), jQuery.fn.mousehold = function (a) {
    var b = 100;
    if (a && "function" == typeof a) {
        ...
        return this.each(function () {
            $(this).mousedown(function () {
                ...
                clearInterval(c), d && a.call(this, 1), d = !1
            }, $(this).mouseout(e), $(this).mouseup(e)
        })
    }
}, !function (a) {
    var b = function (b, d) {
        this.element = a(b), this.element.addClass("noSelect"), this.intervalId = void 0;
        var e = "object" == typeof d;
        this.minimum = a.fn.spinedit.defaults.minimum, e && "number" == typeof d.minimum && this.setMinimum(d.minimum), this.maximum = a.fn.spinedit.defaults.maximum, e && "number" == typeof d.maximum && this.setMaximum(d.maximum), this.numberOfDecimals = a.fn.spinedit.defaults.numberOfDecimals, e && "number" == typeof d.numberOfDecimals && this.setNumberOfDecimals(d.numberOfDecimals);
        var f = a.fn.spinedit.defaults.value;
        if (e && "number" == typeof d.value) f = d.value; else if (this.element.val()) {
            var g = parseFloat(this.element.val());
            isNaN(g) || (f = g.toFixed(this.numberOfDecimals))
        }
        this.setValue(f), this.step = a.fn.spinedit.defaults.step, e && "number" == typeof d.step && this.setStep(d.step);
        var h = a(c.template);
        this.element.next().hasClass("input-group-addon") ? this.element.next().after(h) : this.element.after(h), a(h).each(function (b, c) {
            a(c).bind("selectstart click mousedown", function () {
                return !1
            })
        }), h.find(".glyphicon-chevron-up").mousehold(a.proxy(this.increase, this)), h.find(".glyphicon-chevron-down").mousehold(a.proxy(this.decrease, this)), this.element.on("keypress", a.proxy(this._keypress, this)), this.element.on("blur", a.proxy(this._checkConstraints, this))
    };
    b.prototype = {
        constructor: b, setMinimum: function (a) {
            this.minimum = parseFloat(a)
        }, setMaximum: function (a) {
            this.maximum = parseFloat(a)
        }, setStep: function (a) {
            this.step = parseFloat(a)
        }, setNumberOfDecimals: function (a) {
            this.numberOfDecimals = parseInt(a)
        }, setValue: function (a) {
            a = parseFloat(a), isNaN(a) && (a = this.minimum), this.value != a && (a < this.minimum && (a = this.minimum), a > this.maximum && (a = this.maximum), this.value = a, this.element.val(this.value.toFixed(this.numberOfDecimals)), this.element.change(), this.element.trigger({
                type: "valueChanged",
                value: parseFloat(this.value.toFixed(this.numberOfDecimals))
            }))
        }, increase: function () {
            this.setValue(this.element.val());
            var a = this.value + this.step;
            this.setValue(a)
        }, decrease: function () {
            this.setValue(this.element.val());
            var a = this.value - this.step;
            ...
            if (38 == b) return this.increase(), void 0;
            if (40 == b) return this.decrease(), void 0;
            if (45 != b && !(this.numberOfDecimals > 0 && 46 == b)) {
                for (var c = [], d = 48; 58 > d; d++) c.push(d);
                c.push(37), c.push(39), c.push(8), c.indexOf(b) >= 0 || a.preventDefault()
            }
        }, _checkConstraints: function (b) {
            var c = a(b.target);
            this.setValue(c.val())
        }
    }, a.fn.spinedit = function (c) {
        var d = Array.apply(null, arguments);
        return d.shift(), this.each(function () {
            var e = a(this), f = e.data("spinedit"), g = "object" == typeof c && c;
            f || e.data("spinedit", new b(this, a.extend({}, a.fn.spinedit().defaults, g))), "string" == typeof c && "function" == typeof f[c] && f[c].apply(f, d)
        })
    }, a.fn.spinedit.defaults = {
        value: 0,
        minimum: 0,
        maximum: 100,
        step: 1,
        numberOfDecimals: 0
    }, a.fn.spinedit.Constructor = b;
    var c = {};
    c.template = '<div class="input-group-addon spinedit"><i class="glyphicon glyphicon-chevron-up"></i><i class="glyphicon glyphicon-chevron-down"></i></div>'
}(window.jQuery), angular.module("ui.bootstrap", ["ui.bootstrap.tpls", "ui.bootstrap.transition", "ui.bootstrap.collapse", "ui.bootstrap.accordion", "ui.bootstrap.alert", "ui.bootstrap.bindHtml", "ui.bootstrap.buttons", "ui.bootstrap.carousel", "ui.bootstrap.position", "ui.bootstrap.datepicker", "ui.bootstrap.dropdownToggle", "ui.bootstrap.modal", "ui.bootstrap.pagination", "ui.bootstrap.tooltip", "ui.bootstrap.popover", "ui.bootstrap.progressbar", "ui.bootstrap.rating", "ui.bootstrap.tabs", "ui.bootstrap.timepicker", "ui.bootstrap.typeahead"]), angular.module("ui.bootstrap.tpls", ["template/accordion/accordion-group.html", "template/accordion/accordion.html", "template/alert/alert.html", "template/carousel/carousel.html", "template/carousel/slide.html", "template/datepicker/datepicker.html", "template/datepicker/popup.html", "template/modal/backdrop.html", "template/modal/window.html", "template/pagination/pager.html", "template/pagination/pagination.html", "template/tooltip/tooltip-html-unsafe-popup.html", "template/tooltip/tooltip-popup.html", "template/popover/popover.html", "template/progressbar/bar.html", "template/progressbar/progress.html", "template/rating/rating.html", "template/tabs/tab.html", "template/tabs/tabset-titles.html", "template/tabs/tabset.html", "template/timepicker/timepicker.html", "template/typeahead/typeahead-match.html", "template/typeahead/typeahead-popup.html"]), angular.module("ui.bootstrap.transition", []).factory("$transition", ["$q", "$timeout", "$rootScope", function (a, b, c) {
    function d(a) {
    ...
    this.groups = [], this.scope = a, this.closeOthers = function (d) {
    ...
    return {
        ...
        link: function (b, c, d, e) {
            var f, g;
            e.addGroup(b), b.isOpen = !1, d.isOpen && (f = a(d.isOpen), g = f.assign, e.scope.$watch(f, function (a) {
                b.isOpen = !!a
            })), b.$watch("isOpen", function (a) {
                a && e.closeOthers(b), g && g(e.scope, a)
            })
        }
    }
    ...
    this.minDate = d.minDate ? new Date(d.minDate) : null, this.maxDate = d.maxDate ? new Date(d.maxDate) : null, this.modes = [{
        ...
        getVisibleDates: function (a, b) {
            var d = a.getFullYear(), e = a.getMonth(), k = new Date(d, e, 1), l = j - k.getDay(),
                m = l > 0 ? 7 - l : -l, n = new Date(k), o = 0;
    ...
    return {
        restrict: "EA", require: "ngModel", link: function (h, i, j, k) {
            function l(a) {
                v ? v(h, !!a) : t.isOpen = !!a
            }
            ...
            function p() {
                t.position = s ? d.offset(i) : d.position(i), t.position.top = t.position.top + i.prop("offsetHeight")
            }

            var q;
            j.$observe("datepickerPopup", function (a) {
                q = a || f.dateFormat, k.$render()
            });
            var r = angular.isDefined(j.closeOnDateSelection) ? h.$eval(j.closeOnDateSelection) : f.closeOnDateSelection,
            ...
            h.$on("$destroy", function () {
                ...
                t.currentText = angular.isDefined(a) ? a : f.currentText
            }), j.$observe("toggleWeeksText", function (a) {
                t.toggleWeeksText = angular.isDefined(a) ? a : f.toggleWeeksText
            }), j.$observe("clearText", function (a) {
                t.clearText = angular.isDefined(a) ? a : f.clearText
            }), j.$observe("closeText", function (a) {
                t.closeText = angular.isDefined(a) ? a : f.closeText
            });
            var u, v;
            j.isOpen && (u = b(j.isOpen), v = u.assign, h.$watch(u, function (a) {
                t.isOpen = !!a
            })), t.isOpen = u ? u(h) : !1;
            var w = function (a) {
                t.isOpen && a.target !== i[0] && t.$apply(function () {
                    l(!1)
                })
            }, x = function () {
                t.$apply(function () {
            ...
            }, y = angular.element("<div datepicker-popup-wrap><div datepicker></div></div>");
            y.attr({"ng-model": "date", "ng-change": "dateSelection()"});
            var z = angular.element(y.children()[0]);
            j.datepickerOptions && z.attr(angular.extend({}, h.$eval(j.datepickerOptions))), k.$parsers.unshift(m), t.dateSelection = function () {
                k.$setViewValue(t.date), k.$render(), r && l(!1)
            }, i.bind("input change keyup", function () {
                t.$apply(function () {
                    n()
                })
            }), k.$render = function () {
                var a = k.$viewValue ? e(k.$viewValue, q) : "";
                i.val(a), n()
            }, o(j.min, "min"), o(j.max, "max"), j.showWeeks ? o(j.showWeeks, "showWeeks", "show-weeks") : (t.showWeeks = g.showWeeks, z.attr("show-weeks", "showWeeks")), j.dateDisabled && z.attr("date-disabled", j.dateDisabled);
            var A = !1, B = !1;
            t.$watch("isOpen", function (a) {
                a ? (p(), c.bind("click", w), B && i.unbind("focus", x), i[0].focus(), A = !0) : (A && c.unbind("click", w), i.bind("focus", x), B = !0), v && v(h, a)
            });
            var C = b(j.ngModel).assign;
            t.today = function () {
                C(h, new Date)
            }, t.clear = function () {
                C(h, null)
            ...
            var D = a(y)(t);
            s ? c.find("body").append(D) : i.after(D)
        }
    }
    ...
    function f(a) {
        var b = k.get(a).value;
        k.remove(a), b.modalDomEl.remove(), h && -1 == e() && (h.remove(), h = void 0), b.modalScope.$destroy()
    }
    ...
    return c.$watch(k.length, function () {
        ...
        k.add(a, {deferred: c.deferred, modalScope: c.scope, backdrop: c.backdrop, keyboard: c.keyboard});
    ...
    return {
        ...
        link: function (c, d, e, f) {
            ...
            var h, i = f.getAttributeValue(e.boundaryLinks, b.boundaryLinks),
                ...
                n = f.getAttributeValue(e.lastText, b.lastText, !0), o = f.getAttributeValue(e.rotate, b.rotate);
    ...
    return {
        ...
        link: function (b, c, d, e) {
            ...
            var g = e.getAttributeValue(d.previousText, a.previousText, !0),
                h = e.getAttributeValue(d.nextText, a.nextText, !0), i = e.getAttributeValue(d.align, a.align);
    ...
    this.options = function (a) {
        ...
        return function (e, l, m) {
            ...
            var o = angular.extend({}, b, d), p = a(e), q = k.startSymbol(), r = k.endSymbol(),
                s = "<" + p + '-popup title="' + q + "tt_title" + r + '" content="' + q + "tt_content" + r + '" placement="' + q + "tt_placement" + r + '" animation="tt_animation" is-open="tt_isOpen"></' + p + "-popup>";
            return {
                restrict: "EA", scope: !0, link: function (a, b, c) {
                    function d() {
                        a.tt_isOpen ? m() : k()
                    }

                    function k() {
                        (!z || a.$eval(c[l + "Enable"])) && (a.tt_popupDelay ? (t = g(p, a.tt_popupDelay), t.then(function (a) {
                            a()
                        })) : a.$apply(p)())
                    }
                    ...
                    function p() {
                        return a.tt_content ? (r && g.cancel(r), u.css({
                            ...
                            left: 0,
                            display: "block"
                        }), w ? v.append(u) : b.after(u), A(), a.tt_isOpen = !0, A) : angular.noop
                    }
                    ...
                    var r, t, u = f(s)(a), v = i.find("body"),
                        w = angular.isDefined(o.appendToBody) ? o.appendToBody : !1, x = n(void 0), y = !1,
                        z = angular.isDefined(c[l + "Enable"]), A = function () {
                            var c, d, e, f;
                            switch (c = w ? j.offset(b) : j.position(b), d = u.prop("offsetWidth"), e = u.prop("offsetHeight"), a.tt_placement) {
                                case"right":
                    ...
                    a.tt_isOpen = !1, c.$observe(e, function (b) {
                        b ? a.tt_content = b : a.tt_isOpen && q()
                        ...
                        a.tt_animation = angular.isDefined(b) ? !!b : o.animation
                        ...
                        g.cancel(t), u.remove(), u.unbind(), u = null, v = null
                    })
                }
            }
        }
    ...
    this.makeBar = function (a, b, c) {
        var g = angular.isObject(a) ? a.value : a || 0, h = angular.isObject(b) ? b.value : b || 0,
            i = angular.isObject(a) && angular.isDefined(a.type) ? a.type : f ? d(c || 0) : null;
        return {from: h, to: g, type: i, animate: e}
    ...
    return {
        ...
        scope: {value: "=percent", onFull: "&", onEmpty: "&"},
        templateUrl: "template/progressbar/progress.html",
        link: function (a, b, c, d) {
            a.$watch("value", function (a, b) {
                if (d.clearBars(), angular.isArray(a)) for (var c = 0, e = a.length; e > c; c++) d.addBar(d.makeBar(a[c], b[c], c)); else d.addBar(d.makeBar(a, b))
...
}).controller("TabsetController", ["$scope", function (a) {
    ...
    readonlyInput: !1,
    mousewheel: !0
}).directive("timepicker", ["$parse", "$log", "timepickerConfig", function (a, b, c) {
    return {
        restrict: "EA",
        require: "?^ngModel",
        replace: !0,
        ...
        link: function (d, e, f, g) {
            ...
            function n(a) {
                var b = new Date(o.getTime() + 6e4 * a);
            ...
            if (g) {
                ...
                var s = e.find("input"), t = s.eq(0), u = s.eq(1),
                    v = angular.isDefined(f.mousewheel) ? d.$eval(f.mousewheel) : c.mousewheel;
                if (v) {
                    var w = function (a) {
                ...
                if (d.readonlyInput = angular.isDefined(f.readonlyInput) ? d.$eval(f.readonlyInput) : c.readonlyInput, d.readonlyInput) d.updateHours = angular.noop, d.updateMinutes = angular.noop; else {
                    var x = function (a, b) {
    ...
    return {
        require: "ngModel", link: function (i, j, k, l) {
            var m, n = i.$eval(k.typeaheadMinLength) || 1, o = i.$eval(k.typeaheadWaitMs) || 0,
                ...
                t = b(k.ngModel).assign, u = g.parse(k.typeahead), v = angular.element("<div typeahead-popup></div>");
            v.attr({
                matches: "matches",
                active: "activeIdx",
                ...
                query: "query",
                position: "position"
            }), angular.isDefined(k.typeaheadTemplateUrl) && v.attr("template-url", k.typeaheadTemplateUrl);
            var w = i.$new();
            ...
            var x = function () {
                ...
                var b = {$viewValue: a};
                q(i, !0), c.when(u.source(i, b)).then(function (c) {
                    if (a === l.$viewValue && m) {
                        if (c.length > 0) {
                            w.activeIdx = 0, w.matches.length = 0;
                            for (var d = 0; d < c.length; d++) b[u.itemName] = c[d], w.matches.push({
                                label: u.viewMapper(w, b),
                                model: c[d]
                            });
                            w.query = a, w.position = f.position(j), w.position.top = w.position.top + j.prop("offsetHeight")
                        } else x();
                        q(i, !1)
                    }
                }, function () {
            ...
            l.$parsers.unshift(function (a) {
                return m = !0, a && a.length >= n ? o > 0 ? (z && d.cancel(z), z = d(function () {
                    y(a)
                }, o)) : y(a) : (q(i, !1), x()), p ? a : a ? (l.$setValidity("editable", !1), void 0) : (l.$setValidity("editable", !0), a)
            }), l.$formatters.push(function (a) {
                var b, c, d = {};
                return s ? (d.$model = a, s(i, d)) : (d[u.itemName] = a, b = u.viewMapper(i, d), d[u.itemName] = void 0, c = u.viewMapper(i, d), b !== c ? b : a)
            }), w.select = function (a) {
                var b, c, d = {};
                d[u.itemName] = c = w.matches[a].model, b = u.modelMapper(i, d), t(i, b), l.$setValidity("editable", !0), r(i, {
                    $item: c,
                    $model: b,
                    $label: u.viewMapper(i, d)
                }), x(), j[0].focus()
            }, j.bind("keydown", function (a) {
                return 0 === w.matches.length || -1 === h.indexOf(a.which) ? (13 === a.which && a.preventDefault(), void 0) : (a.preventDefault(), 40 === a.which ? (w.activeIdx = (w.activeIdx + 1) % w.matches.length, w.$digest()) : 38 === a.which ? (w.activeIdx = (w.activeIdx ? w.activeIdx : w.matches.length) - 1, w.$digest()) : 13 === a.which || 9 === a.which ? w.$apply(function () {
                    w.select(w.activeIdx)
                }) : 27 === a.which && (a.stopPropagation(), x(), w.$digest()), void 0)
            }), j.bind("blur", function () {
                m = !1
            });
            var A = function (a) {
                j[0] !== a.target && (x(), w.$digest())
            };
            e.bind("click", A), i.$on("$destroy", function () {
                e.unbind("click", A)
            }), j.after(a(v)(w))
        }
    }
    ...
    a.put("template/modal/window.html", '<div class="modal fade {{ windowClass }}" ng-class="{in: animate}" ng-style="{\'z-index\': 1050 + index*10, display: \'block\'}" ng-click="close($event)">\n    <div class="modal-dialog"><div class="modal-content" ng-transclude></div></div>\n</div>')
    ...
    a.put("template/progressbar/bar.html", '<div class="progress-bar" ng-class=\'type && "progress-bar-" + type\'></div>')
    ...
    a.put("template/tabs/tabset-titles.html", "<ul class=\"nav {{type && 'nav-' + type}}\" ng-class=\"{'nav-stacked': vertical, 'nav-justified': justified}\">\n</ul>\n")
    ...
    a.value("prefix", "ls"), a.constant("cookie", {expiry: 30, path: "/"}), a.constant("notify", {
        setItem: !0,
        removeItem: !1
    }), a.service("localStorageService", ["$rootScope", "prefix", "cookie", "notify", function (a, b, c, d) {
        "." !== b.substr(-1) && (b = b ? b + "." : "");
        var e = function () {
            try {
            ...
            if (!e()) return a.$broadcast("LocalStorageModule.notification.warning", "LOCAL_STORAGE_NOT_SUPPORTED"), d.setItem && a.$broadcast("LocalStorageModule.notification.setitem", {
                key: c,
                newvalue: f,
                storageType: "cookie"
            }), l(c, f);
            ...
            try {
                (angular.isObject(f) || angular.isArray(f)) && (f = angular.toJson(f)), localStorage.setItem(b + c, f), d.setItem && a.$broadcast("LocalStorageModule.notification.setitem", {
                    key: c,
                    newvalue: f,
                    storageType: "localStorage"
                })
            } catch (g) {
                return a.$broadcast("LocalStorageModule.notification.error", g.message), l(c, f)
            }
            return !0
        }, g = function (c) {
            if (!e()) return a.$broadcast("LocalStorageModule.notification.warning", "LOCAL_STORAGE_NOT_SUPPORTED"), m(c);
            var d = localStorage.getItem(b + c);
            return d && "null" !== d ? "{" === d.charAt(0) || "[" === d.charAt(0) ? angular.fromJson(d) : d : null
        }, h = function (c) {
            if (!e()) return a.$broadcast("LocalStorageModule.notification.warning", "LOCAL_STORAGE_NOT_SUPPORTED"), d.removeItem && a.$broadcast("LocalStorageModule.notification.removeitem", {
                key: c,
                storageType: "cookie"
            }), n(c);
            try {
                localStorage.removeItem(b + c), d.removeItem && a.$broadcast("LocalStorageModule.notification.removeitem", {
                    key: c,
                    storageType: "localStorage"
                })
            } catch (f) {
                return a.$broadcast("LocalStorageModule.notification.error", f.message), n(c)
            }
            return !0
        }, i = function () {
            if (!e()) return a.$broadcast("LocalStorageModule.notification.warning", "LOCAL_STORAGE_NOT_SUPPORTED"), !1;
            var c = b.length, d = [];
            for (var f in localStorage) if (f.substr(0, c) === b) try {
                d.push(f.substr(c))
            } catch (g) {
            ...
            if (!e()) return a.$broadcast("LocalStorageModule.notification.warning", "LOCAL_STORAGE_NOT_SUPPORTED"), o();
            var c = b.length;
            for (var d in localStorage) if (d.substr(0, c) === b) try {
                h(d.substr(c))
            } catch (f) {
                return a.$broadcast("LocalStorageModule.notification.error", f.message), o()
            }
            return !0
        }, k = function () {
            try {
            ...
            if (!k()) return a.$broadcast("LocalStorageModule.notification.error", "COOKIES_NOT_SUPPORTED"), !1;
            try {
                var f = "", g = new Date;
                null === e ? (g.setTime(g.getTime() + -864e5), f = "; expires=" + g.toGMTString(), e = "") : 0 !== c.expiry && (g.setTime(g.getTime() + 24 * c.expiry * 60 * 60 * 1e3), f = "; expires=" + g.toGMTString()), d && (document.cookie = b + d + "=" + encodeURIComponent(e) + f + "; path=" + c.path)
            } catch (h) {
                return a.$broadcast("LocalStorageModule.notification.error", h.message), !1
            }
            return !0
        }, m = function (c) {
            if (!k()) return a.$broadcast("LocalStorageModule.notification.error", "COOKIES_NOT_SUPPORTED"), !1;
            for (var d = document.cookie.split(";"), e = 0; e < d.length; e++) {
                ...
                if (0 === f.indexOf(b + c + "=")) return decodeURIComponent(f.substring(b.length + c.length + 1, f.length))
            }
            return null
        }, n = function (a) {
            l(a, null)
        }, o = function () {
            for (var a = null, c = b.length, d = document.cookie.split(";"), e = 0; e < d.length; e++) {
                for (a = d[e]; " " == a.charAt(0);) a = a.substring(1, a.length);
                key = a.substring(c, a.indexOf("=")), n(key)
            }
        };
        return {
            isSupported: e,
            ...
            remove: h,
            clearAll: j,
            cookie: {set: l, add: l, get: m, remove: n, clearAll: o}
        }
    }])
}.call(this);
...
angular.module("localization", []).factory("localize", ["$http", "$rootScope", "$window", "$filter", function (a, b, c) {
    debugger
    var d = {
        debugger;
        language: "", dictionary: [], url: void 0, resourceFileLoaded: !1, successCallback: function (a) {
            d.dictionary = a, d.resourceFileLoaded = !0, b.$broadcast("localizeResourcesUpdated")
        }, setLanguage: function (a) {
            d.language = a, d.initLocalizedResources()
        }, setUrl: function (a) {
            d.url = a, d.initLocalizedResources()
        }, buildUrl: function () {
            if (!d.language) {
                var a, b;
                a = c.navigator && c.navigator.userAgent && (b = c.navigator.userAgent.match(/android.*\W(\w\w)-(\w\w)\W/i)) ? b[1] : c.navigator.userLanguage || c.navigator.language, d.language = a
            }
            return "i18n/resources-locale_" + d.language + ".json"
        }, initLocalizedResources: function () {
            var b = d.url || d.buildUrl();
            return a({method: "GET", url: b, cache: !1}).success(d.successCallback).error(function () {
                var b = "/i18n/resources-locale_en_US.json";
                a({method: "GET", url: b, cache: !1}).success(d.successCallback)
            })
        }, getLocalizedString: function (a, b) {
            var c = "!" + a + "!";
            if (!d.resourceFileLoaded && !b) {
                var e = d.initLocalizedResources();
                return d.resourceFileLoaded = !0, e.then(function () {
                    return d.getLocalizedString(a)
                })
            }
            if ("object" != typeof d.dictionary) return a;
            for (var f = [], g = 1; g < arguments.length; g++) f.push(arguments[g]);
            var h = function (a, b) {
                var b = b || null, c = d.dictionary[a];
                return void 0 === c ? sprintf(a, b) : sprintf(c, b)
            }, i = h(a, f);
            return null !== c && void 0 != c && (c = i), c
        }
    };
    return d.initLocalizedResources(), d
}]).filter("i18n", ["localize", function (a) {
    return function (b) {
        return a.getLocalizedString(b, !0)
    }
}]).directive("i18n", ["localize", function (a) {
    var b = {
        restrict: "EAC", updateText: function (b, c) {
            var d = c.split("|");
            if (d.length >= 1) {
                var e = a.getLocalizedString(d[0]);
                if (null !== e && void 0 !== e && "" !== e) {
                    if (d.length > 1) for (var f = 1; f < d.length; f++) {
                        var g = "{" + (f - 1) + "}";
                        e = e.replace(g, d[f])
                    }
                    b.text(e)
            ...
            a.$on("localizeResourcesUpdated", function () {
                b.updateText(c, d.i18n)
            }), d.$observe("i18n", function () {
                b.updateText(c, d.i18n)
            })
        }
    };
    return b
}]).directive("i18nAttr", ["localize", function (a) {
    var b = {
        restrict: "EAC", updateText: function (b, c) {
            var d = c.split("|"), e = a.getLocalizedString(d[0]);
            if (null !== e && void 0 !== e && "" !== e) {
                if (d.length > 2) for (var f = 2; f < d.length; f++) {
                    var g = "{" + (f - 2) + "}";
                    e = e.replace(g, d[f])
                }
                b.attr(d[1], e)
            ...
            a.$on("localizeResourcesUpdated", function () {
                b.updateText(c, d.i18nAttr)
            }), d.$observe("i18nAttr", function (a) {
                b.updateText(c, a)
            })
        }
    };
    ...
    function c(a, b, c, d) {
        var e = ["opacity", b, ~~(100 * a), c, d].join("-"), f = .01 + c / d * 100,
            g = Math.max(1 - (1 - a) / b * (100 - f), a), h = k.substring(0, k.indexOf("Animation")).toLowerCase(),
            i = h && "-" + h + "-" || "";
    ...
    i.defaults = {}, f(i.prototype, {
        spin: function (b) {
            ...
            if (b && (b.insertBefore(i, b.firstChild || null), d = g(b), c = g(i), e(i, {
                ...
                var l, m = 0, n = (h.lines - 1) * (1 - h.direction) / 2, o = h.fps, p = o / h.speed,
                    q = (1 - h.opacity) / (p * h.trail / 100), r = p / h.lines;
                !function s() {
                    m++;
    ...
    return {
        ...
        extend: function () {
            for (var a = 1; a < arguments.length; a++) for (var b in arguments[a]) arguments[a].hasOwnProperty(b) && (arguments[0][b] = arguments[a][b]);
            return arguments[0]
        },
        stringParsers: [{
    ...
    return {
        value: {h: 1, s: 1, b: 1, a: 1}, rgb: function () {
            var a = this.toRGB();
            ...
            for (var c in a.stringParsers) {
                ...
                if (d.space || "rgba", f) return this.value = this.RGBtoHSB.apply(null, f), !1
            }
        }, setHue: function (a) {
            this.value.h = 1 - a
...
}]).directive("colorpicker", ["$document", "$compile", "Color", "helper", "$timeout", function (a, b, c, d, e) {
    return {
        require: "?ngModel", restrict: "A", link: function (f, g, h, i) {
            var j, k, l, m, n,
                o = '<div class="colorpicker dropdown-menu"><div class="clickarea"><div class="colorpicker-saturation"><i><b></b></i></div><div class="colorpicker-hue"><i></i></div><div class="colorpicker-alpha"><i></i></div><div class="colorpicker-color"><div /></div></div><div class="colorpicker-color-value"><div /><input value="{{model}}" /></div></div>',
                p = angular.element(o), q = c, r = null, s = null, t = h.colorpicker ? h.colorpicker : "hex";
            b(p)(f), k = {
                enabled: "rgba" === t,
                css: null
            }, k.enabled === !0 && (p.addClass("alpha"), k.css = p.find("div")[2].style), angular.element(document.body).append(p), i && (i.$render = function () {
                g.val(i.$viewValue)
            }, f.$watch(h.ngModel, function () {
                y()
            })), g.bind("$destroy", function () {
                p.remove()
            }), l = p.find(".clickarea div")[0].style, j = p.find(".clickarea div")[4].style, m = p.find("i"), n = p.find("input");
            var u = function () {
                try {
                    j.backgroundColor = q[t]()
                } catch (a) {
                    j.backgroundColor = q.toHex()
                }
                l.backgroundColor = q.toHex(q.value.h, 1, 1, 1), k.enabled === !0 && (k.css.backgroundColor = q.toHex())
            }, v = function (a) {
                a.stopPropagation(), a.preventDefault();
                var b = d.closest(a.target, "div");
                if ("colorpicker-saturation" === b.className) s = d.extend({}, {
                    maxLeft: 100,
                    maxTop: 100,
                    callLeft: "setSaturation",
                    callTop: "setLightness"
                }); else if ("colorpicker-hue" === b.className) s = d.extend({}, {
                    maxLeft: 0,
                    maxTop: 100,
                    callLeft: !1,
                    callTop: "setHue"
                }); else {
                    if ("colorpicker-alpha" !== b.className) return !1;
                    s = d.extend({}, {maxLeft: 0, maxTop: 100, callLeft: !1, callTop: "setAlpha"})
                }
                s.knob = b.children[0].style, s.left = a.pageX - d.getOffset(b).left, s.top = a.pageY - d.getOffset(b).top, r = {
                    left: a.pageX,
                    top: a.pageY
                }
            }, w = function (a) {
                var b = Math.max(0, Math.min(s.maxLeft, s.left + ((a.pageX || r.left) - r.left))),
                    c = Math.max(0, Math.min(s.maxTop, s.top + ((a.pageY || r.top) - r.top)));
                s.knob.left = b + "px", s.knob.top = c + "px", s.callLeft && q[s.callLeft].call(q, b / 100), s.callTop && q[s.callTop].call(q, c / 100), u();
                var d = q[t]();
                return g.val(d), i && f.$apply(i.$setViewValue(d)), !1
            }, x = function () {
                a.unbind("mousemove", w), a.unbind("mouseup", x)
            }, y = function (a) {
                a && g.val(a), q.setColor(g.val()), m.eq(0).css({
                    left: 100 * q.value.s + "px",
                    top: 100 - 100 * q.value.b + "px"
                }), m.eq(1).css("top", 100 * (1 - q.value.h) + "px"), m.eq(2).css("top", 100 * (1 - q.value.a) + "px"), u(), n.val(q[t]())
            };
            g.bind("click", function () {
                y(), p.addClass("colorpicker-visible").css({
                    top: d.getOffset($(g).next()[0]).top + $(g).next()[0].offsetHeight - document.body.scrollTop + "px",
                    left: d.getOffset($(g).next()[0]).left - document.body.scrollLeft + "px"
                })
            }), p.bind("mousedown", function (a) {
                $(a.target).is(".colorpicker-color-value input") || (a.stopPropagation(), a.preventDefault())
            });
            var z;
            n.bind("keyup", function () {
                var a = n.val(), b = q.setColor(a);
                z && e.cancel(z), z = e(function () {
                    "undefined" != typeof b && y(a)
                }, 500)
            }), p.find(".clickarea div").bind("click", function (a) {
                v(a), w(a)
            }), p.find(".clickarea div").bind("mousedown", function (b) {
                v(b), a.bind("mousemove", w), a.bind("mouseup", x)
            }), a.bind("mousedown", function (a) {
                $(a.target).is(".colorpicker-color-value input") || p.hasClass("colorpicker-visible") && p.removeClass("colorpicker-visible")
            })
        }
    }
}]);
